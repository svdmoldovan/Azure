...
namespace ManageKeyVault
{
    public class Program
    {
        ...
        public static void RunSample(IAzure azure)
        {
            ...
            try
            {
                ...
                vault1 = vault1.Update()
                        .DefineAccessPolicy()
                            .ForServicePrincipal(SdkContext.AzureCredentialsFactory.FromFile(GetAzureAuthLocation()).ClientId)
        ...
        public static string GetAzureAuthLocation()
        {
            var location = Environment.GetEnvironmentVariable("AZURE_AUTH_LOCATION");
            return location ?? @"d:\Apps\Azure\key-vault-dotnet-manage-key-vaults\my.azureauth";
        }
        ...
        public static void Main(string[] args)
        {
            try
            {
                //=================================================================
                // Authenticate
                AzureCredentials credentials = SdkContext.AzureCredentialsFactory.FromFile(GetAzureAuthLocation());
